...
# --- SÉCURITÉ MAXIMALE 🔒 ---
# On regarde si la clé est dans le coffre-fort de Streamlit (Cloud)
if "GEMINI_API_KEY" in st.secrets:
    api_key = st.secrets["GEMINI_API_KEY"]
else:
    # Si on est en local sur ton PC, on met un texte bidon (ou tu peux gérer autrement)
    # MAIS SURTOUT PAS TA VRAIE CLÉ EN CLAIR ICI !!!
    api_key = "ahhhhh_no_trop_dangereux_nooooooo"
